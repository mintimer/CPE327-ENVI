...
<head>
    ...
    <?php
    require 'connect.php';
    $sql = "SELECT * FROM campaigninfo  ORDER BY start_time";
...
<body>
    ...
    <div class="contain">
            ...
            for ($x = 0; $x < $num; $x++) {
                ...
                echo '<div class="boxview">
                    ...
                    <div class="campaigndetailbutton">
                        <form action="./adminviewdetailall.php" method="post" id="select-form">
        ...
        <p class="textnosub" id="camname">No campaign create now.</p>
