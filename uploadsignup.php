...
require 'connect.php';
session_start();
$sql = "INSERT INTO `userinfo`(`username`, `password`, `firstname`, `lastname`, `phone_no`, `email`, `picture_path` , `goodness_point`) 
        VALUES ('".$_SESSION['username']."', '".$_SESSION['password']."', '".$_SESSION['firstname']."', '".$_SESSION['lastname']."'
        , '".$_SESSION['phone_no']."', '".$_SESSION['email']."','".$_SESSION['picpath']."', 100)";
